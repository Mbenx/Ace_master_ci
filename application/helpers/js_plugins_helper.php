...
function highcharts() {
    return   
            ...
            '<script src="' . base_url('/assets/highchart/exporting_1.js') . '"></script>' . "\n" .
            '<script src="' . base_url('/assets/highchart/canvg.min.js') . '"></script>' . "\n".
            '<script src="' . base_url('/assets/highchart/rgb.js') . '"></script>' . "\n";
}
